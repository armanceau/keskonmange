      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Sélectionnez vos ingrédients et obtenez des recettes personnalisées
            instantanément
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="shadow-sm border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 backdrop-blur-sm">
            <CardContent className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                <Button
                  className="w-full sm:w-auto bg-linear-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-200"
                  size="lg"
                  onClick={callMistral}
          ...
          {recipe && (
            <Card className="shadow-sm border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 backdrop-blur-sm">
              <CardHeader className="bg-linear-to-r from-orange-50 to-red-50 dark:from-gray-950/50 dark:to-gray-900/50 border-b dark:border-zinc-800">
